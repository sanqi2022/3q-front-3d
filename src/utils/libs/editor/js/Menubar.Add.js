...
function MenubarAdd(editor) {
  ...
  var addSplineObject = function (position, pa, index) {
  ...
  option.onClick(function () {
    ...
    points.push(new THREE.Vector3(0, 0, 1.4));
    points.push(new THREE.Vector3(0, 0, 1.8));
    ...
    let inx = 0
    for (let p of points) {
      let fk = addSplineObject(p, line, inx++)
      mesh.add(fk)
    }
